...
\item \textbf{Agentic AI}: Deep-dive research of multi-agent systems, \textit{LLM orchestration}, and autonomous reasoning frameworks; evaluated cutting-edge agentic IDEs and frameworks including \textit{Claude Code/Cursor/Codex}, \textit{LangChain},\textit{AG2}, \textit{CrewAI}, \textit{LlamaIndex}, \textit{OAI Swarm}, \textit{Claude Agents SDK}, and custom harnesses. 
\item \textbf{Strategic Advisory}: Provided technical guidance to early-stage startups (\href{https://enosys.ai/}{enosys.ai}, \href{https://facts.ai/}{facts.ai}, \href{https://wasmer.io/}{Wasmer}, \textit{Eni6ma}) on AI strategy, model selection, and production requirements; advised on \textit{Agentic AI} integration patterns and AI architecture design.
...
\cventry{2003--2010}{\large Software Architect/Research Engineer}{School of CS at Univ. Politécnica de Madrid (UPM)}{Spain}{\textbf{Roles}: Distributed Systems Expert, Software Architect, Software Engineer}{%
...
\cventry{2003--2011}{\large Researcher}{School of CS at Universidad Politécnica de Madrid (UPM)}{Spain}{\textbf{Roles}: PhD. Candidate/Researcher}{%
\begin{itemize}[leftmargin=*,noitemsep,topsep=0pt,parsep=3pt,partopsep=0pt]
\item \textbf{Ph.D. Thesis: Middleware for High Available and Scalable Multi-Tier and Service-Oriented Architectures (2003--2009)}: Advisors: Prof. Marta Patiño-Martínez and Prof. Ricardo Jiménez-Péris (UPM). \textbf{Specialization} -- \textit{Distributed Systems, Transactional Systems, Scalability, High Availability, SOAs}. Developed a brand-new approach to provide high availability and scalability to multi-tier architectures by combining snapshot-isolation and an innovative vertical replication approach.
\item \textbf{Research Internship at SARDES Research Group at INRIA Grenoble, France (2007)}: Advisor: Prof. Sara Bouchenak. Integration of self-configuration and self-repair properties of autonomic computing in the core of a cloud platform.
\item \textbf{Publications in Top Conferences and Journals}: (1) \textit{Elastic SI-Cache: Consistent and Scalable Caching in Multi-Tier Architectures}. In VLDB Journal, 2011 \textbf{44 Citations}; (2) \textit{Scalability Evaluation of the Replication Support of JOnAS, an Industrial J2EE Application Server}. In EDCC Conf., Valencia (Spain), 2010 \textbf{10 Citations}; (3) \textit{A System of Architectural Patterns for Scalable, Consistent and Highly Available Multi-tier Service Oriented Infrastructure}. In Architecting Dependable Systems VI, Springer, 2009 \textbf{13 Citations}; (4) \textit{Consistent and Scalable Cache Replication for Multi-tier J2EE Applications}. In ACM/IFIP/USENIX Middleware Conf., CA (USA), 2007 \textbf{43 Citations}; (5) \textit{WS-Replication: A Framework for Highly Available Web Services}. In ACM WWW Conf., Edinburgh, 2006 \textbf{230 Citations}; (6) \textit{Highly Available Long Running Transactions and Activities for J2EE Applications}. In IEEE ICDCS Conf., Lisbon (Portugal), 2006 \textbf{28 Citations}; (7) \textit{ZenFlow: A Visual Tool for Web Service Composition}. In IEEE VL/HCC Conf., Dallas (USA), 2005 \textbf{53 Citations}.
\end{itemize}
}
...
% \setcvskillcolumns[][0.85][]
% %\cvskillhead[<post -padding >][<level>][<skill>][<years of experience>][<comment>]
% \cvskillhead[0em][Level][Skill][Years][Desc]
% %\cvskillentry*[<post -padding >]{< skill category >}{<0-5>}{<skill name >}{< years of experience >}{< comment >}
% \cvskillentry*[1em]{AI/ML \& DS}{5}{Agentic AI Fmwks (OpenAI, CrewAI, etc.)\linebreak HF Transformers, PyTorch, Scikit-learn.}{8}{}

\subsection{AI/ML \& Data Science}
\cvitem{AI/ML}{Agentic AI Fmwks (OpenAI, CrewAI, etc.), HF Transformers, PyTorch, Scikit-learn.}
\cvitem{Areas}{Gen AI, NLP, Multi-label Classification, Knowledge Graphs.}
...
\cvitem{Tools}{Agentic Tools (Cursor, Claude Code), Git, GH Actions, GitLab CI, IntelliJ, VSCode.}
...
\cvitem{BigData}{Distributed Processing, Highly Available and Scalable System Design, Perf. Tuning.}
...
%\cvline{Enterprise}{Economy and business management basics}
...
\cvitem{Academia}{Taught undergraduate courses in [specific subject/area], developing curriculum and guiding students through core concepts and practical applications.}

\subsection{Technical Communication}
\cvitem{Misc.}{Presented research findings at both international and national conferences, 
effectively communicating complex ideas to diverse audiences. Delivered project updates in internal meetings within corporate environments. Authored 10+ peer-reviewed publications with extensive citations.}

\subsection{Professional Service}
\cvitem{Apache}{Committer and maintainer for \textit{Apache Omid}; conference reviewer; active open-source maintainer of \textit{\href{https://crates.io/crates/mdbook-bib}{mdbook-bib}} (Bibliography management tool).}
...
\cvcomputer{Spanish}{\textit{Mother tongue}}{English}{\textit{Professional proficiency}} % (written and spoken)
\cvcomputer{French}{\textit{Intermediate proficiency}}{Catalan}{\textit{Intermediate proficiency}} % (listening, reading, \& speaking)
...
\begin{itemize}[leftmargin=*,noitemsep,topsep=0pt,parsep=3pt,partopsep=0pt]
\item \textit{Coding Agents: AI Driven Dev Conference}, Mar 3rd-4th, 2026, San Francisco, CA (USA)
\item \textit{Neurips 2025 conference}, Dec 2nd-7th, 2025, San Diego, CA (USA)
\item \textit{Decentralized AGI Summit (dAGI) 2025}, Oct 24rd, 2025, San Francisco, CA (USA)
\item \textit{Agentic AI Summit}, Aug 2nd, 2025, Berkeley, CA (USA)
\item \textit{AI Engineer World's Fair}, Jun 3rd-5th, 2025, San Francisco, CA (USA)
\item \textit{MLSys 2025 conference}, May 11th-15th, 2025, Santa Clara, CA (USA)
\item \textit{AI Dev 2025}, Apr 4rd, 2025, San Francisco, CA (USA)
\item \textit{Neurips 2024 conference}, Dec 10th-15th, 2024, Vancouver, BC (Canada)
\item \textit{ICML 2024 conference}, Jul 21st-27th, 2024, Vienna (Austria)
\item \textit{AI Engineer World's Fair}, Jun 25th-27th, 2024, San Francisco, CA (USA)
\item \textit{MLSys 2024 conference}, May 13th-16th, 2024, Santa Clara, CA (USA)
\item \textit{W\&B Fully Connected Conference 2024, The Era of Generative AI}, Apr 17th-18th, 2024, San Francisco, CA (USA)
\item \textit{Neurips 2023 conference}, Dec 10th, 2023, New Orleans, LA (USA)
\item \textit{Amazon Re:Invent 2023}, Nov 27th-30th, 2023, Las Vegas, NV (USA)
\item \textit{Ray Summit 2023}, Sep 18th-20th, 2023, San Francisco, CA (USA)
\item \textit{ICML 2023 conference}, Jul 23rd-29th, 2023, Honolulu, Hawaii (USA)
\item \textit{MLSys 2023 conference}, Jun 4th-8th, 2023, Miami, FL (USA)
\item \textit{Ray Summit 2022}, Aug 23rd-24th, 2022, San Francisco, CA (USA)
\item \textit{MLSys 2022 conference}, Aug 31st-Sept 3rd, 2022, Santa Clara, CA (USA)
\item \textit{ACL 2019 conference (Speaker)}, Jul 28th-Aug 2nd, 2019, Florence (Italy)
\item \textit{@Scale conference}, Aug 31st, 2016, San Jose, CA (USA)
\item \textit{Hadoop Summit (Speaker)}, Jun 28th-30th, 2016, San Jose, CA (USA)
\item \textit{@Scale conference}, Sep 14th, 2015, San Jose, CA (USA)
\item \textit{Hadoop Summit Europe}, Apr 15th-16th, 2015, Brussels (Belgium)
\item \textit{Hadoop Summit Europe}, Apr 2nd-3rd, 2014, Amsterdam (Netherlands)
\item \textit{NoSQL Matters Conf.}, Nov 21st-22nd, 2014, Barcelona (Spain)
\item \textit{NoSQL Matters Conf.}, Nov 29th-30th, 2013, Barcelona (Spain)
\item \textit{NoSQL Matters Conf.}, Oct 6th, 2012, Barcelona (Spain)
\item \textit{IEEE International Symposium on Reliable Distributed Systems (SRDS)}, Oct 4th-7th, 2011, Madrid (Spain)
\item \textit{World Wide Web Conference}, Apr 20th-24th, 2009, Madrid (Spain)
\item \textit{Spanish Conference on Concurrency and Distributed Systems}, Sep 13th-16th, 2005, Granada (Spain)
\item \textit{ObjectWebCon'05}, Jan 17th-20th, 2005, Lyon (France)
\item \textit{ObjectWeb's Workshop on Transactions}, Feb 23rd-24th, 2004, Grenoble (France)
\item \textit{ObjectWeb's Architecture Meeting}, Jan 13th-15th, 2004, Sevilla (Spain)
\end{itemize}
}
\cventry{}{Member}{}{}{}{
\begin{itemize}[leftmargin=*,noitemsep,topsep=0pt,parsep=3pt,partopsep=0pt]
\item \textit{Apache Software Foundation (ASF)}, \href{https://www.apache.org/}{https://www.apache.org/}
\item \textit{ObjectWeb Consortium}, \href{http://www.ow2.org}{http://www.ow2.org}
\item \textit{Java Community Process program (JCP)}, \href{http://jcp.org}{http://jcp.org}
\end{itemize}
}
...
\cvline{}{Beyond my core professional focus, but some way related to it, I have a strong interest in the 
